...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_ergodox_pretty(
    ...
    KC_LCTRL,       XXXXXXX,        KC_LCTRL,       KC_LALT,        KC_LGUI,                                                                                                        XXXXXXX,        XXXXXXX,        XXXXXXX,        XXXXXXX,        TT(3),
  ...
  [3] = LAYOUT_ergodox_pretty(
    ...
    KC_MS_ACCEL2,   XXXXXXX,        _______,        _______,        _______,                                                                                                        XXXXXXX,        XXXXXXX,        XXXXXXX,        XXXXXXX,        _______,
                                                                                                    XXXXXXX,        XXXXXXX,        XXXXXXX,        XXXXXXX,
                                                                                                                    XXXXXXX,        XXXXXXX,
